...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/oslo.config-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/oslo.config-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add oslo.config
# for installing globally
pixi global install oslo.config
```
...
It is possible to list all of the versions of `oslo.config` available on your platform:
...
```
pixi search oslo.config --channel conda-forge
```
